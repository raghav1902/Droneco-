...
const StepMedia = ({ formData, handleBasicChange, prevStep, nextStep, validationErrors }) => {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="form-group" style={{ marginBottom: '2rem' }}>
        <label className="form-label">Upload Passport Size Photograph *</label>
      ...
      <div className="form-group" style={{ marginBottom: '2.5rem' }}>
        <label className="form-label">Upload Student Signature *</label>
        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
          <input
            type="file"
            accept="image/*"
